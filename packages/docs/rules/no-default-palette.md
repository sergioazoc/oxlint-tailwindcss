---
title: "no-default-palette — Tailwind CSS lint rule"
...
oxlint rule that reports Tailwind CSS default palette colors, like `bg-red-500`, in a project whose
theme defines its own colors — and names the ones to use.

## At a glance

| Autofix | Editor suggestions | Design system           | Options               |
| ------- | ------------------ | ----------------------- | --------------------- |
| No      | No                 | Required (`entryPoint`) | `entryPoint`, `allow` |
