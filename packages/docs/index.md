...
hero:
  ...
  tagline: 27 rules, designed for Tailwind v4. Deterministic, fast, fail-loud.
  actions:
    - theme: brand
      text: Get started
      link: /setup
...
the `<script>` of Vue, Svelte and Astro files) against it, with 27 rules, most with an autofix.
