---
title: "no-dynamic-classes — regla de lint para Tailwind CSS"
...
Regla de oxlint que reporta clases de Tailwind CSS armadas en runtime, como `bg-${color}-500`, que
Tailwind nunca ve escritas y por eso no genera CSS para ellas.
