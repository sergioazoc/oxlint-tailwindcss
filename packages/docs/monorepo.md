---
title: "Monorepos"
description: "Use oxlint-tailwindcss in a monorepo: one config with an entryPoint mapping, or one .oxlintrc.json per package, and what can differ between packages."
---
