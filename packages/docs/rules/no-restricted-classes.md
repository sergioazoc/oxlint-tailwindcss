---
title: "no-restricted-classes — Tailwind CSS lint rule"
...
oxlint rule that bans the Tailwind CSS classes you list, by exact name or regex, each with a message
...
| ------- | ------------------ | ------------- | --------------------- |
| No      | No                 | Not used      | `classes`, `patterns` |
