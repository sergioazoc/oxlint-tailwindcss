---
title: "no-arbitrary-value — Tailwind CSS lint rule"
...
oxlint rule that reports Tailwind CSS arbitrary values like `w-[200px]` or `bg-[#ff0000]`, so values
come from your theme; an allow list covers exceptions.
