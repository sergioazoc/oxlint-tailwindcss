---
title: "no-borrowed-component-styles — Tailwind CSS lint rule"
...
oxlint rule that reports a plain element rebuilding one of your components from Tailwind CSS
classes: a hand-made Button, Card or Input.

::: warning Experimental

Its heuristics may still change in a minor release, adding or removing reports. It is off in the
recommended config.
...
| ------- | ------------------ | ----------------------- | -------------------------- |
| No      | No                 | Required (`entryPoint`) | `components`, `entryPoint` |
